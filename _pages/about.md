...
<div style="text-align: justify; margin-bottom: 50px;">
    <div>
        <h3 style="display: inline; margin-bottom: 10px;">Inflation Risk and Yield Spread Changes, (SSRN)</h3>
...
<div style="text-align: justify; margin-bottom: 50px; margin-top: 20px;">
    <div>
        <h3 style="display: inline; margin-bottom: 10px;">Good Inflation, Bad Inflation: Implications for Risky Asset Prices, with Berardino Palazzo and Ram Yamarthy (SSRN)</h3>
