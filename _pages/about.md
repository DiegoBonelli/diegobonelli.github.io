...
<div style="text-align: justify; margin-bottom: 50px;">
    <div>
        <h3 style="display: inline; margin-bottom: 5px;">Inflation Risk and Yield Spread Changes, (SSRN)</h3>
...
<div id="abstract" style="display: none; margin-top: 5px;">
    <text>
...
<div style="text-align: justify; margin-bottom: 50px; margin-top: 10px;">
    <div>
        <h3 style="display: inline; margin-bottom: 5px;">Good Inflation, Bad Inflation: Implications for Risky Asset Prices, with Berardino Palazzo and Ram Yamarthy (SSRN)</h3>
