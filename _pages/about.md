...
<div style="text-align: justify; margin-bottom: 20px;margin-top: 20px;">
    ...
    <button style="margin-left: 0; border: none" onclick="window.location.href='https://www.federalreserve.gov/econres/feds/good-inflation-bad-inflation-implications-for-risky-asset-prices.htm';" class="custom-button small">FED WP</button>
