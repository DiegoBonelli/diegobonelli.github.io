...
Here we will establish a connection between the R script and WRDS, which will allow us to download directly from the script. Substitute Useraname and Password with yours username and password for WRDS.
...
wrds <- dbConnect(Postgres(),
                  ...
                  port=9737,
                  user='bonellid', # insert your username
                  password='Cb689xf1', # insert your password
                  dbname='wrds',
                  sslmode='require')
```
